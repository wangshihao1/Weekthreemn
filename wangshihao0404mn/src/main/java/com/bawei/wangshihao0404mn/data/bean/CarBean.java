...
public class CarBean {
    ...
    public static class DataBean {
        ...
        private boolean maxChecked;

        public boolean getMaxChecked() {
            return maxChecked;
        }

        public void setMaxChecked(boolean maxChecked) {
